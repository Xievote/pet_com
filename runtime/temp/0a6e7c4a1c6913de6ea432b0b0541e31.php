<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"C:\Users\EDY\tp5\public/../application/index\view\pet\index.html";i:1778310108;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <title>宠物生活记录</title>
...
<body>
    ...
    <div class="section">
        ...
        <div class="list-box" id="petLogList">
            ...
            <div class="pagination">
                ...
                <?php endif; $__FOR_START_1342115353__=1;$__FOR_END_1342115353__=$logs['last_page'];for($i=$__FOR_START_1342115353__;$i < $__FOR_END_1342115353__;$i+=1){ if($i == $logs['current_page']): ?>
    ...
    <div class="section">
        ...
        <div class="pagination">
            ...
            <?php else: ?>
            <span class="disabled">上一页</span>
            <?php endif; $__FOR_START_2094283626__=1;$__FOR_END_2094283626__=$posts['last_page'];for($i=$__FOR_START_2094283626__;$i < $__FOR_END_2094283626__;$i+=1){ if($i == $posts['current_page']): ?>
            <span class="active"><?php echo $i; ?></span>
            <?php else: ?>
